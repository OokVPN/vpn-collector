...
const COUNTRY_NAMES = {
  ...
  FI: 'Финляндия', SE: 'Швеция', PL: 'Польша', TR: 'Турция', JP: 'Япония',
  SG: 'Сингапур', CA: 'Канада', CH: 'Швейцария', AT: 'Австрия', ES: 'Испания',
  IT: 'Италия', BE: 'Бельгия', NO: 'Норвегия', DK: 'Дания', IE: 'Ирландия',
  PT: 'Португалия', RO: 'Румыния', BG: 'Болгария', CZ: 'Чехия', HU: 'Венгрия',
  GR: 'Греция', UA: 'Украина', KZ: 'Казахстан', AM: 'Армения', GE: 'Грузия',
  AZ: 'Азербайджан', IN: 'Индия', KR: 'Южная Корея', HK: 'Гонконг', TW: 'Тайвань',
  AU: 'Австралия', NZ: 'Новая Зеландия', BR: 'Бразилия', AR: 'Аргентина', MX: 'Мексика',
  AE: 'ОАЭ', IL: 'Израиль', SA: 'Саудовская Аравия', EG: 'Египет', ZA: 'ЮАР',
  LT: 'Литва', LV: 'Латвия', EE: 'Эстония', HR: 'Хорватия', SI: 'Словения',
  SK: 'Словакия', MD: 'Молдова', RS: 'Сербия', IS: 'Исландия', LU: 'Люксембург',
  MT: 'Мальта', CY: 'Кипр', VN: 'Вьетнам', TH: 'Таиланд', ID: 'Индонезия',
  MY: 'Малайзия', PH: 'Филиппины', CN: 'Китай'
};
...
const WHITE_TRIGGERS = ['обход глушилок', 'белые списки', 'обход белых списков', 'lte', '5g', '⚪', 'бс', 'БС', 'обход'];
